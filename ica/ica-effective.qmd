...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am (Celsius)", y = "Temperature at 3pm (Celsius)", title = "Temperatures in Australia in the morning and afternoon", color = "Location")  
```
...
```{r}
#| fig-cap: "Temperatures (Celsius) in different locations in Australia at 9am and 3pm"

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am (Celsius)", y = "Temperature at 3pm (Celsius)", color = "Location")  
```
...
```{r}
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "A density plot of 3pm temperatures in 3 Australian locations. A typical temperature in Hobart is between 10-20 degrees Celsius. Uluru ranges from 15-40 degrees, and Wollongong ranges from 15-25 degrees."
